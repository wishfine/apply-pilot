...
CANONICAL_EXACT_RULES: dict[str, str] = {
    ...
    "出生年月": "identity.birth_date",
    "出生时间": "identity.birth_date",
    "生日": "identity.birth_date",
    "出生年份": "identity.birth_date",
    "出生月份": "identity.birth_date",
    "出生日期年份": "identity.birth_date",
    "出生日期月份": "identity.birth_date",
    "出生年": "identity.birth_date",
    "出生月": "identity.birth_date",
    "出生日": "identity.birth_date",
    "证件类型": "identity.id_type",
    "证件种类": "identity.id_type",
    ...
    "手机": "contact.mobile",
    "移动电话": "contact.mobile",
    "手机区号": "contact.mobile_country_code",
    "国际区号": "contact.mobile_country_code",
    "国家代码": "contact.mobile_country_code",
    "区号": "contact.mobile_country_code",
    "邮箱": "contact.email",
    "电子邮箱": "contact.email",
    "email": "contact.email",
    ...
    "现居住地省份": "contact.current_city",
    "现居住地城市": "contact.current_city",
    "现居住地(省)": "contact.current_city",
    "现居住地(市)": "contact.current_city",
    ...
    "入学年份": "education[__HIGHEST__].start_date",
    "入学月份": "education[__HIGHEST__].start_date",
    "入学年": "education[__HIGHEST__].start_date",
    "入学月": "education[__HIGHEST__].start_date",
    "毕业时间": "education[__HIGHEST__].end_date",
    "毕业日期": "education[__HIGHEST__].end_date",
    "毕业年份": "campus_context.graduation_year",
    "毕业月份": "campus_context.graduation_month",
    "毕业年": "campus_context.graduation_year",
    "毕业月": "campus_context.graduation_month",
    ...
    "籍贯省份": "soe_extended.native_place",
    "籍贯城市": "soe_extended.native_place",
    "籍贯区县": "soe_extended.native_place",
    "籍贯(省)": "soe_extended.native_place",
    "籍贯(市)": "soe_extended.native_place",
    "籍贯(区/县)": "soe_extended.native_place",
    ...
    "户籍省份": "soe_extended.household_registration",
    "户籍城市": "soe_extended.household_registration",
    "户籍区县": "soe_extended.household_registration",
    "户籍所在地省份": "soe_extended.household_registration",
    "户籍所在地城市": "soe_extended.household_registration",
    "户籍所在地(省)": "soe_extended.household_registration",
    "户籍所在地(市)": "soe_extended.household_registration",
